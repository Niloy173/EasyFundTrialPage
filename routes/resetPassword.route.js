...
const {ResetPasswordSchema} = require("../models/RestPassowordSchema");
  ...
  ResetPassword.find({ userId })
    .then(result => {
      ...
      if(result.length > 0)
      {
        ...
        const message = "Password already reset recently.please try again later or send another request from forget password";
    ...
    ResetPassword
          ...
          if(result.length > 0)
          {
            ...
            if(expiresAt < Date.now())
            {
              ...
              .then(() => {
                ...
                const message = "password reset link has been expired.Try again";
                res.redirect(url.format({
                  pathname : "/register/verified/",
                  query : {
        ...
        .catch(error => {
          ...
          res.json({
            ...
            message : "Checking for existing password reset record failed Due to some error"
          })
        })
        ...
        // now we send the email
          ...
          const mailOptions = {
            ...
            html : `<h2> Welcome to Easy Fund </h2>
                          ...
                          <p> <a href=${redirectUrl + "resetpassword/reset/" + _id + "/" + resetString}> click here </a> to proceed </p>`,
           ...
           .then(hashedResetString => {
              ...
              newPasswordReset
                ...
                .catch(error => {
                  ...
                  console.log(error)
                  res.render("resetPassword",{
                    message : "An error occured while saving the password reset data"
                  });
                })
